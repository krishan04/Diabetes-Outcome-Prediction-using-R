...
Run the script line by line or execute the entire script.

Choose the dataset file (CSV format) when prompted.

Review the output in the R console and plots generated by ggplot2.
...
Accuracy metrics for k-NN, Naive Bayes, Logistic Regression, and Decision Tree models.

A comparison of the model performances.

## Potential Improvements

Implement additional data preprocessing steps if necessary (e.g., handling outliers, feature selection).

Experiment with other machine learning models such as Random Forest or SVM.
